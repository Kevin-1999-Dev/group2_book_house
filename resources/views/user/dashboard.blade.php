        ...
        <div class="container">
            ...
            <div class="row mt-5 box-one">
                <div class="col-6 pt-3 text">
                    ...
                    <a href="{{ route('public.book') }}" class="btn btn-success w-50 p-2 mt-2">Wanna Try?</a>
                </div>
                <div class="col-6">
            ...
            <div class="row mt-5 box-two">
                ...
                <div class="manage col-6 text">
                    ...
                    <a href="" class="text-decoration-none btn btn-success w-50 text-white mt-2 p-2"><i>More...</i></a>
                </div>
            </div>
        </div>
    </section>
