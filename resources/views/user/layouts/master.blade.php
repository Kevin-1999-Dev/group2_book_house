            ...
            <div class="container-fluid">
                <div class="container d-flex">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item mx-3 fw-bold"><a href="{{ route('public.index') }}" class="nav-link active" aria-current="page">Dashboard</a></li>
                    ...
                    <div class="dropdown col-3 offset-1 float-right text-center">
                        <img src="{{ asset('images/female.jpg') }}" alt="default" class="profile border border-white rounded-circle dropdown-toggle" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
