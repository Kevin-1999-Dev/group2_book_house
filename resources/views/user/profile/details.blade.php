...
<div class="profile-pg py-5">
    <div class="col-11 col-md-10 col-lg-6 mx-auto bg-light row p-3 rounded-2 border border-danger-subtle">
        ...
        <div class="my-3">
            <a href="{{ route('user.editPage') }}" class="btn btn-sm btn-dark w-25 col-4 offset-6">Edit</a>
            <a href="{{ route('user.delete',Auth::user()->id) }}" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-danger w-25 col-4 offset-6 mt-1">Delete Account</a>
        </div>
    </div>
</div>
@endsection