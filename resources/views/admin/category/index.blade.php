...
@endsection
@section('content')
<div class="category-pg col-12 col-md-10 col-lg-8 mx-auto pb-5">
    @if ($errors->any())
                    ...
                    <table class="table table-striped f-7">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $category->name }}</td>
                                <td>
                                    <a href="{{ route('admin.category.edit', $category->id) }}"><span class="btn btn-sm btn-success">Edit</span></a>
                                    <a href="{{ route('admin.category.delete', $category->id) }}" onclick="return confirm('Are you sure?')"><span class="btn btn-sm btn-danger">Delete</span></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
