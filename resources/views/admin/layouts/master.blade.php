            ...
            <div class="container-fluid">
                <div class="container d-flex">
                    ...
                    <div class="dropdown col-3 offset-1 float-right text-center">
                        <img src="{{ asset('images/male.png') }}" alt="default" class="profile border border-white rounded-circle dropdown-toggle" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
