...
@endsection
@section('content')
<div class="auth-feedback col-12 col-md-10 mx-auto ">
@if ($errors->any())
                    ...
                    <table class="table table-striped f-7">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#detailModal" data-bs-modal-id="{{$feedback->id}}">View</button>
                                    <a href="{{route('admin.feedback.delete',$feedback->id)}}"><span class="btn btn-sm btn-danger">Delete</span></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
