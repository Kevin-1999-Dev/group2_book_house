...
@endsection
@section('content')
<div class="author-pg col-11 col-md-10 col-lg-8 mx-auto pb-5">
    @if ($errors->any())
                    ...
                    <table class="table table-striped f-7">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $author->name }}</td>
                                <td>
                                    <a href="{{ route('admin.author.edit', $author->id) }}"><span class="btn btn-sm btn-success d-none d-lg-inline-block">Edit</span></a>
                                    <a href="{{ route('admin.author.edit', $author->id) }}" class="me-1"><i class="fa-solid fa-pen-to-square text-success d-lg-none"></i></a>
                                    <a href="{{ route('admin.author.delete', $author->id) }}" onclick="return confirm('Are you sure?')"><span class="btn btn-sm btn-danger d-none d-lg-inline-block">Delete</span></a>
                                    <a href="{{ route('admin.author.delete', $author->id) }}"><i class="fa-solid fa-trash text-danger d-lg-none"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
