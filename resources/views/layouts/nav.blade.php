<nav class="navbar navbar-expand-lg bg-body-secondary border-bottom border-danger-subtle fixed-top shadow-sm">
  <div class="container-fluid">
    ...
    <a class="btn btn-outline-dark btn-sm d-lg-none" href="{{ route('public.cart.index') }}">
        <i class="fa fa-shopping-cart" aria-hidden="true"></i> <span class="badge text-bg-danger" id="totalItem">{{isset((session('cart')['totalItem'])) ? (session('cart')['totalItem']) : "0"}}</span>
      </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div class="d-flex">
        ...
        <div class="dropdown d-none d-lg-block">
          ...
          @endif
          <ul class="dropdown-menu dropdown-menu-lg-start dropdown-menu-dark w-100" aria-labelledby="dropdownMenu2">
            <li><a href="{{ route('admin.details') }}" class="dropdown-item p-3">Profile</a></li>
            <li><a href="{{ route('admin.changePasswordPage') }}" class="dropdown-item p-3">Change Password</a></li>
            <li class="p-2">
              <form action="{{ route('logout') }}" method="POST">
