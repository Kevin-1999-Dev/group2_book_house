<nav class="navbar navbar-expand-lg bg-body-secondary border-bottom border-danger-subtle fixed-top shadow-sm">
    <div class="container-fluid">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-dark" aria-labelledby="dropdownMenu2">
                    ...
                    <li class="p-1">
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button class="dropdown-item bg-primary text-white p-1 text-center rounded-3 f-6" type="submit">Logout</button>
                        </form>
                    </li>
                </ul>
            </div>
        ...
        <button class="navbar-toggler btn p-1" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="d-flex me-lg-5">
                ...
                <div class="dropdown d-none d-lg-block">
                    @if (Auth::user()->image == null)
                    <img src="{{ asset('images/default.png') }}" alt="default" class="profile border border-white rounded-circle dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    @else
                    <img src="{{ asset('storage/' . Auth::user()->image) }}" alt="default" class="profile border border-white rounded-circle dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    @endif
                    <ul class="dropdown-menu dropdown-menu-lg-end dropdown-menu-dark w-100" aria-labelledby="dropdownMenu2">
