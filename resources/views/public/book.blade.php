...
<div class="px-3 px-md-3 px-lg-5 book-pg">
        ...
        <div class="clearfix mt-2">
            <span class="dropdown float-startend me-2">
                ...
                <ul class="dropdown-menu">
                    <li><a href="{{ route('public.book',['sort'=>'asc','s'=>Request::get('s')]) }}" class="dropdown-item" type="button">Ascending</a></li>
                    <li><a href="{{ route('public.book',['sort'=>'desc','s'=>Request::get('s')]) }}" class="dropdown-item" type="button">Descending</a>
                    </li>
                </ul>
            </span>
    ...
    <div class="clearfix d-none d-md-block pt-4 pt-md-0">
        ...
        <span class="dropdown float-end me-2">
            ...
            <ul class="dropdown-menu">
                <li><a href="{{ route('public.book',['sort'=>'asc','s'=>Request::get('s')]) }}" class="dropdown-item" type="button">Ascending</a></li>
                <li><a href="{{ route('public.book',['sort'=>'desc','s'=>Request::get('s')]) }}" class="dropdown-item" type="button">Descending</a></li>
            </ul>
        </span>
    </div>
    <div class="my-3 row">
