...
<div class="container-fluid container mt-2">
      <h2>Discover a World of Available Books</h2>
          ...
          <div class="card shadow-sm bg-body-secondary">
            <div class="card-body text-center">
              ...
              @endforeach
                ...
                <span class="up-date">: {{$book->date}}</span><br>
              ...
              @if (!empty(Auth::user()))
              <a href="#" class="btn btn-success btn-sm col-12 mx-auto" type="button"><i class="fa-solid fa-cart-plus"></i> Add to Cart</a>
              @else
              <a href="{{ route('auth.loginPage') }}" class="btn btn-success btn-sm col-12 mx-auto" type="button"><i class="fa-solid fa-cart-plus"></i> Add to Cart</a>
              @endif
            </div>
          </div>
        </div>
