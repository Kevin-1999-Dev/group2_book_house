        ...
        <div class="intro row d-flex align-items-center">
            ...
            <div class="col-12 col-md-6">
                <div class="card-body mv-txt mx-4 mx-md-0 me-md-3 mx-lg-5 p-2 p-md-0">
                    <h2 class="f-2 mb-3">Welcome to <span class="bookhouse">BOOK HOUSE</span>!!! <i
                            class="fa-regular fa-face-grin-hearts"></i></h2>
                    <p class="f-4 mb-2">
                        your <span class="mark-txt">premier destination</span> for both printed books and
                        digital ebooks is <spam class="mark-txt">here</spam>.<br><span class="mark-txt">Immerse
                            yourself</span> in a world of
                        captivating stories and boundless knowledge.<br><span class="mark-txt">Unleash your
                            imagination</span> as you explore our vast collection
                        of titles, carefully curated to satisfy every reader's taste.
                    </p>
                    <p class="f-6 mb-3">Whether you prefer the tactile experience of
                        turning pages or the convenience of digital reading, <span class="bookhouse f-5">BOOK HOUSE</span>
                        ...
                        <div class="row">
                            @foreach ($books as $book)
                                <a href="{{ route('public.book_detail', $book->id) }}"
                                    class="col-6 col-sm-4 col-md-6 col-lg-4 mb-3">
                                    <div class="card shadow-sm bg-body-secondary">
                                        <div class="card-body book-card">
                                            <img src="{{ $book->cover }}" alt="book-cover"
                                                class="book-cover rounded-top-2 d-block mx-auto mb-1">
                                            ...
                                            @foreach ($book->category as $category)
                                                <span
                                                    class="bg-danger-subtle px-1 rounded-1 f-s">{{ $category->name }}</span>
                                            @endforeach
                                            <p class="f-s mt-1">
                            ...
                            <div class="d-grid gap-2 col-12 mb-4 mb-lg-0">
                                <a class="btn btn-sm btn-dark col-6 mx-auto" type="button"
                                    href="{{ route('public.book') }}">See More</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            @foreach ($ebooks as $ebook)
                                <a href="{{ route('public.ebook_detail', $ebook->id) }}"
                                    ...
                                    <div class="card shadow-sm bg-body-secondary">
                                        <div class="card-body book-card">
                                            <img src="{{ $ebook->cover }}" alt="book-cover"
                                                class="book-cover rounded-top-2 d-block mx-auto mb-1">
                            ...
                            <div class="d-grid gap-2 col-12 mb-4 mb-lg-0">
                                <a class="btn btn-sm btn-dark col-6 mx-auto" type="button"
                                    href="{{ route('public.ebook') }}">See More</a>
                            </div>
                        </div>
                    </div>
                </div>
