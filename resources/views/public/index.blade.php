    ...
    <div class="col-md-6 col-sm-12">
      <div class="px-5 pt-md-5">
        <div class="card-body py-md-5">
          <h2>Welcome to <span class="bookhouse">BOOKHOUSE</span>!!! <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-emoji-heart-eyes" viewBox="0 0 16 16">
          ...
          <p>Whether you prefer the tactile experience of
            turning pages or the convenience of digital reading, <span class="bookhouse fs-5">BOOKHOUSE</span> is here to accompany you on your literary
            journey.
          </p>
          @if (empty(Auth::user()))
          ...
          @else
          <a href="" class="btn btn-success">See your books</a>
          @endif
        </div>
      </div>
    </div>
...
<div class="container-fluid border-bottom border-top border-info py-2  bg-body-secondary">
  <div class="row">
    <!-- Books -->
    <div class="col-md-6">
      <div class="card shadow-sm">
      <h3 class="py-md-1 shadow-sm ps-2 border-bottom border-info-subtle">Avilable Books</h3>
        <div class="card-body">
            ...
            <div class="col">
              <div class="card shadow-sm bg-body-secondary">
                <div class="card-body">
                  ...
                  <button class="btn btn-success btn-sm col-12 mx-auto" type="button">Add to Cart</button>
                </div>
              </div>
            </div>
            @endforeach
    ...
    <div class="col-md-6">
      <div class="card shadow-sm">
      <h3 class="py-md-1 shadow-sm ps-2 border-bottom border-info-subtle">Avilable E-books</h3>
        <div class="card-body">
          <div class="row row-cols-2 row-cols-sm-2 row-cols-md-3 g-3">
