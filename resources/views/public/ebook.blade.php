            ...
            <div class="clearfix mt-2">
                <span class="dropdown float-startend me-2">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('public.ebook.asc') }}" class="dropdown-item" type="button">Ascending</a>
                        </li>
                        <li><a href="{{ route('public.ebook.desc') }}" class="dropdown-item" type="button">Descending</a>
                        </li>
                    </ul>
                </span>
